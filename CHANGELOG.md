...
### Changed
- Updated project root CLAUDE.md with Snow-Flow specific content
- Cleaned up cli.ts removing duplicate init command code

For full details, see [CHANGELOG-1.4.6.md](./CHANGELOG-1.4.6.md)
