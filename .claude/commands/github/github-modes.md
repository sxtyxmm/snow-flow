...
mcp__snow-flow__agent_spawn { type: "coordinator", name: "GitHub Coordinator" }
mcp__snow-flow__agent_spawn { type: "reviewer", name: "Code Reviewer" }
mcp__snow-flow__agent_spawn { type: "tester", name: "QA Agent" }

// Execute GitHub workflow with coordination
mcp__snow-flow__task_orchestrate { task: "GitHub workflow", strategy: "parallel" }
```